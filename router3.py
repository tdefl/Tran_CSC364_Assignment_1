...
def start_server():
    ...
    try:
        ...
        forwarding_table_path = "input/router_3_table.csv"
        ...
        soc.close()
        print("Server socket closed by Router 3")
...
#           # 7. Store the source IP, destination IP, payload, and TTL.
       ...
       # 9. Convert the destination IP into an integer for comparison purposes.
        ...
        #     write_to_file('./output/sent_by_router_3.txt', new_packet, sending_port)
        ...
        #     write_to_file('./output/sent_by_router_3.txt', new_packet, "a")
    ...
    connection.close()
    print("Connections closed by router 3")
